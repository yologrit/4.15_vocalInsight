...
interface AnnotationPanelProps {
  ...
  activeTechniqueKey: string | null;
...
const AnnotationPanel = ({ activeTechnique, activeTechniqueKey, selectedLine, showBreathInfo, onFavorite, isRegistered }: AnnotationPanelProps) => {
  ...
  // Use position-based key so each technique instance has independent state
  const currentKey = activeTechniqueKey || "none";
  const state = feedbackState[currentKey] || {
    likeCount: getInitialLikeCount(currentKey),
    hasLiked: false,
