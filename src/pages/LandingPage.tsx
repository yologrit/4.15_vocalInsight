...
import featureAnalyze from "@/assets/feature-analyze.png";
import featureCompare from "@/assets/feature-compare.png";
import featurePractice from "@/assets/feature-practice.png";
...
const WaveformHeroAnimation = () => {
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto h-40 md:h-52 flex items-center justify-center overflow-hidden">
      <motion.svg
        viewBox="0 0 600 120"
...
const coreFeatures = [
  ...
  { step: "Step 3 · 建议", title: "应该练什么？", description: "问题太多不知从何练起？自动识别最核心的问题，为你定制循序渐进的微练习，让进步看得见。", image: featurePractice },
];
...
const LandingPage = () => {
  ...
  useEffect(() => {
    // Preload images
    [featureAnalyze, featureCompare, featurePractice].forEach((src) => {
      const img = new Image();
      img.src = src;
    });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-4 px-4 bg-gradient-hero min-h-[calc(100vh-4rem)] flex flex-col justify-center mt-16">
        <div className="container mx-auto text-center max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent text-accent-foreground text-sm mb-4 animate-fade-in">
            <Sparkles className="w-4 h-4" />
            首款 AI 驱动的「声乐拆解与陪练」助手
          </div>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            让每一句歌
            <br />
            <span className="text-gradient-primary">唱得明明白白</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto mb-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
